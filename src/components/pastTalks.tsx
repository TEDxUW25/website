...
const pastTalks = [
  {
    id: 1,
    title: "Success Isn't Linear",
    desc: "Jordan Howlett",
    youtube: "https://www.youtube.com/watch?v=oKN1d6sremo",
  },
  {
    id: 2,
    title:
      "I Draw Real World Inspiration from Things I Use to Escape from the Real World",
    desc: "Arda Ocal",
    youtube: "https://www.youtube.com/watch?v=2CJHCBLAeWo",
  },
  {
    id: 3,
    title: "AI Will Set Education Back 2500 Years... And That's a Good Thing",
    desc: "Robert Clapperton",
    youtube: "https://www.youtube.com/watch?v=ZcIkF4gLvsc",
  },
  {
    id: 4,
    title:
    ...
    desc: "Camelia Nunez",
    youtube: "https://www.youtube.com/watch?v=KF8ZResRLLs",
  },
  {
    id: 5,
    title: "Taking Unreasonable Bets",
    desc: "Dhananja Jayalath",
    youtube: "https://www.youtube.com/watch?v=2Y8Y49nqiN0",
  },
  {
    id: 6,
    title: "Achieving Excellence: One Choice & Three Practices",
    desc: "Anil Gupta",
    youtube: "https://www.youtube.com/watch?v=3Ez9Lm-0Qu8",
  },
  {
    id: 7,
    title: "Why you will fail to have a great career",
    desc: "Larry Smith",
    youtube: "https://www.youtube.com/watch?v=iKHTawgyKWQ",
  },
  {
    id: 8,
    title: "A Friend in Debt",
    desc: "Patrick Gill",
    youtube: "https://www.youtube.com/watch?v=7BNBU484XOE",
  },
  {
    id: 9,
    title: "Why life is all about REAL connections.",
    desc: "Michael Bociurkiw",
    youtube: "https://www.youtube.com/watch?v=BXu_V1qfw0I",
  },
];
...
const PastTalks: React.FC = () => {
  ...
  const autoPlaySpeed = 8000; // 8 seconds per slide
  ...
  return (
    <div>
      <section className="relative flex flex-col items-center justify-center w-full min-h-[700px] pt-8 md:pt-10 pb-10 bg-white overflow-hidden p-10">
        {/* White gradient overlay for title readability */}
        <div className="absolute top-0 left-0 w-full h-32 md:h-40 z-10 bg-gradient-to-b from-white via-white/95 to-transparent pointer-events-none" />
        {/* Background image */}
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-6xl mx-auto">
          ...
          <div className="relative w-full max-w-6xl">
            <div
              className="overflow-hidden h-[250px] sm:h-[200px] md:h-[200px] lg:h-[240px]"
              ref={carouselRef}
            >
              <AnimatePresence
                initial={false}
              ...
              {Array.from({ length: totalSlides }).map((_, i) => (
                <motion.button
                  ...
                  animate={{
                    ...
                    backgroundColor: i === currentIndex ? "#dc2626" : "#9ca3af",
                  }}
                  transition={{
                    type: "spring",
                    stiffness: 500,
                  ...
                  className="h-4 rounded-full focus:outline-none hover:bg-gray-600 transition-colors shadow-md"
